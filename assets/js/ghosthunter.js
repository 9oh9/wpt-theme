...
(function( $ ) {
	...
	var pluginMethods	= {
        ...
        this.use(lunr.multiLanguage('en', 'ru', 'fr', 'de', 'es'))
        this.ref('id')
      ...
      */
      ...
      var url = site_url + "/ghost/api/v2/content/posts/?key=" + search_api_key + "&limit=all&fields=id,title,url,created_at&formats=plaintext";
      ...
      $.get(url).done(function(data) {
        searchData = data.posts;
            ...
            featureImage: String(arrayItem.feature_image)
					...
					blogData[arrayItem.id] = {title: arrayItem.title, pubDate: tempdate, link: arrayItem.url};
				});
      });
			this.isInit = true;
		},
